...
package {
	...
	import com.crazyfm.extension.starlingApp.configs.StarlingConfigBuilder;
	...
	public class PreInit extends Sprite
	{
		...
		private function added(event:Event):void
		{
			...
			starlingConfigBuilder.context3DProfile = Context3DProfile.BASELINE; //to keep antialiasing
			starlingConfigBuilder.antiAliasing = 8;
